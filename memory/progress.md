...
## In Progress
- Backend gaps plan at `.claude/backend-gaps-implementation-plan.md` — Phases 1 (shipped `840813a`), 2 (shipped `34b49f9`), 3 (shipped `98431e5`), 4 (shipped `be1b843`) done. Phases 5–7 still queued (client enabled in PATCH, client soft-delete, HttpOnly cookies).
